...
using ApiDoc.Helpers.Facturacion.Helpers;
...
{
    #region Contexto
    protected readonly PermisosApi Validador = new PermisosApi();
    ...
    private readonly string ImagesHostname = ConfigurationManager.AppSettings["ImagesHostname"];
    private readonly string ImagesDomainHostname = ConfigurationManager.AppSettings["ImagesDomainHostname"];
    ...
    protected ApiDoc.Models.Responses.ErrorCodeResponseBase RespuestaNoPermisos => new ApiDoc.Models.Responses.ErrorCodeResponseBase
    {
        Message = _mensajeNoPermisos,
        ResponseCode = (int)ResponseTypes.CodigoPermisos,
    };
    protected ApiDoc.Models.Responses.ErrorCodeResponseBase RespuestaNoAutentificado => new ApiDoc.Models.Responses.ErrorCodeResponseBase
    {
        Message = _mensajeNoAutentificado,
        ResponseCode = (int)ResponseTypes.CodigoAutentificacion,
    };
    protected ApiDoc.Models.Responses.ErrorCodeResponseBase RespuestaOkMensaje(string mensaje) => new ApiDoc.Models.Responses.ErrorCodeResponseBase
    {
        ResponseCode = (int)ResponseTypes.CodigoOk,
        Message = mensaje
    };
    protected ApiDoc.Models.Responses.ErrorCodeResponseBase RespuestaOk => new ApiDoc.Models.Responses.ErrorCodeResponseBase
    {
        ResponseCode = (int)ResponseTypes.CodigoOk,
    };
    protected ApiDoc.Models.Responses.ErrorCodeResponseBase RespuestaErrorInterno => new ApiDoc.Models.Responses.ErrorCodeResponseBase
    {
        Message = _mensajeErrorServidor,
        ResponseCode = (int)ResponseTypes.CodigoExcepcion,
    };
    protected static ApiDoc.Models.Responses.ErrorCodeResponseBase RespuestaErrorValidacion(ModelStateDictionary modelState) => new ApiDoc.Models.Responses.ErrorCodeResponseBase
    {
    ...
    protected static ApiDoc.Models.Responses.ErrorCodeResponseBase RespuestaErrorValidacion(string errors) => new ApiDoc.Models.Responses.ErrorCodeResponseBase
    {
        Message = errors,
        ResponseCode = (int)ResponseTypes.CodigoValidacion,
    };
    #endregion
    protected string ObtenerUrlImagen(string route)
    {
        return ImagesHostname + route;
    }

    protected string ObtenerUrlDomainImagen(string route)
    {
        return ImagesDomainHostname + route;
    }
