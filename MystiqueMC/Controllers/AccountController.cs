...
namespace MystiqueMC.Controllers
{
    ...
    public class AccountController : BaseController
    {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        string code1 = await _userManager.GeneratePasswordResetTokenAsync(user.Id);

                        //Create URL with above token

                        var lnkHref = Url.Action("ResetPassword", "Account", new { email = model.Email, code = code1 }, protocol: Request.Url.Scheme);
                        ...
                        string body = "<p>Hemos recibido una petición para restablecer la contraseña de tu cuenta.</p>" +
                            ...
                            "<b>Porfavor click en enlace para restablecer.</b><br/>"
                            + "<a href=\"" + lnkHref + "\">Restablecer contraseña</a>";
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                usuarios users = await Contexto.usuarios.Where(c => c.email == model.Email).FirstAsync();
