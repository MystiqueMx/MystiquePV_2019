...
// Type: MystiqueMC.Helpers.DataAnnotation.RequiredIfEmptyAttribute
...
{
  public class RequiredIfEmptyAttribute : RequiredAttribute
  {
    ...
    protected override ValidationResult IsValid(object value, ValidationContext validationContext)
    {
      ...
      object obj = property.GetValue(validationContext.ObjectInstance);
      string str = obj as string;
      return obj != null && !string.IsNullOrWhiteSpace(str) || this.IsValid(value) ? ValidationResult.Success : new ValidationResult(this.FormatErrorMessage(validationContext.DisplayName));
    }
  }
}
