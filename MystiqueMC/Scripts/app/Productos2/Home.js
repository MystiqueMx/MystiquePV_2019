...
function OnScriptsLoad() {
    ...
    $("#f").on("change", () => $("#form-search").submit());
    SetUpImageInput();
    SetUpImageCropper();
    SetUpDualSelectList();
    SetUpToggles();
...
function SetUpToggles() {
    $('.btn-vista').on('click', ToggleVista);
}
...
function ToggleVista(ev) {
    var $this = $(ev.currentTarget);
    $('.btn-vista').removeClass('active');
    $this.addClass('active');
    switch (ev.currentTarget.id) {
        case 'toggle-receta':
            $('.view-cuadricula').addClass('hide');
            $('.view-lista').removeClass('hide');
        ...
        case 'toggle-combo':
            ...
            $('.view-lista').removeClass('hide');
            $('.collapse').collapse('hide');
            $('.collapse-combo').collapse('show');
            break;
        case 'toggle-variedad':
            $('.view-cuadricula').addClass('hide');
            $('.view-lista').removeClass('hide');
            $('.collapse').collapse('hide');
            $('.collapse-variedades').collapse('show');
            break;
        case 'toggle-lista':
            $('.view-cuadricula').addClass('hide');
            $('.view-lista').removeClass('hide');
        ...
        default:
            $('.collapse').collapse('hide');
            $('.view-cuadricula').removeClass('hide');
            $('.view-lista').addClass('hide');
            break;
    }
}