...
namespace MystiqueNative.Droid.HazPedido.Ensaladas
{
    ...
    public class EnsaladasPaso2Activity : BaseActivity
    {
        protected override int LayoutResource => Resource.Layout.activity_haz_pedido_ensaladas_paso2;
        ...
        private void ButtonSiguiente_Click(object sender, System.EventArgs e)
        {
            ...
            {
                StartActivityForResult(typeof(EnsaladasPaso4Activity), 1);
            }
            else
            {
