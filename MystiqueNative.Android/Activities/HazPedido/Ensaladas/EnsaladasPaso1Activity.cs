...
namespace MystiqueNative.Droid.HazPedido.Ensaladas
{
    ...
    public class EnsaladasPaso1Activity : BaseActivity
    {
        protected override int LayoutResource => Resource.Layout.activity_haz_pedido_ensaladas_paso1;
        ...
        private void _buttonSiguiente_Click(object sender, System.EventArgs e)
        {
            ...
            {
                StartActivityForResult(typeof(EnsaladasPaso2Activity), 1);
            }
            else
            {
