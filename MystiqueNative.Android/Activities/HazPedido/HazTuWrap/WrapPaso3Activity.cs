...
namespace MystiqueNative.Droid.HazPedido.HazTuWrap
{
    ...
    public class WrapPaso3Activity : BaseActivity
    {
        protected override int LayoutResource => Resource.Layout.activity_haz_pedido_wrap_paso3;
        ...
        {
            StartActivityForResult(typeof(WrapPaso1Activity), 1);
        }
    }
}