...
{
    public class TarjetasBottomSheet : BottomSheetDialogFragment
    {
        public static TarjetasBottomSheet Instance => new TarjetasBottomSheet();
        ...
        {
            var view = inflater.Inflate(Resource.Layout.dialog_haz_pedido_bottomsheet_tarjetas, container, false);
