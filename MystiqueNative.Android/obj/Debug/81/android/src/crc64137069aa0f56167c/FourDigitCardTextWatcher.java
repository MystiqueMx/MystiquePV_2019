package crc64137069aa0f56167c;


public class FourDigitCardTextWatcher
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MystiqueNative.Droid.Utils.Tarjetas.FourDigitCardTextWatcher, Fresco", FourDigitCardTextWatcher.class, __md_methods);
	}


	public FourDigitCardTextWatcher ()
	{
		super ();
		if (getClass () == FourDigitCardTextWatcher.class) {
			mono.android.TypeManager.Activate ("MystiqueNative.Droid.Utils.Tarjetas.FourDigitCardTextWatcher, Fresco", "", this, new java.lang.Object[] {  });
		}
	}
