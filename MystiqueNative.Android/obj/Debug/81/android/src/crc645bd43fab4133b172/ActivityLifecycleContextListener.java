...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MystiqueNative.Droid.Utils.ActivityLifecycleContextListener, Fresco", ActivityLifecycleContextListener.class, __md_methods);
	}
	...
	public ActivityLifecycleContextListener ()
	{
		...
		if (getClass () == ActivityLifecycleContextListener.class) {
			mono.android.TypeManager.Activate ("MystiqueNative.Droid.Utils.ActivityLifecycleContextListener, Fresco", "", this, new java.lang.Object[] {  });
		}
	}
