...
using static MystiqueNative.Droid.Utils.Views.ChipUtils;
...
namespace MystiqueNative.Droid.Utils.Views
{
    public class Chip : RelativeLayout
    {
        ...
        protected override void OnMeasure(int widthMeasureSpec, int heightMeasureSpec)
        {
            ...
            thisParams.Height = ViewGroup.LayoutParams.WrapContent;
        ...
        private void OnSelectTouchDown()
        {
            ...
            InitBackgroundColor();
            InitTextView();
            _selectIcon.SetImageResource(Resource.Drawable.ic_checkbox_marked_circle_grey600_24dp);
        ...
        private void OnCloseTouchDown()
        {
            ...
            InitBackgroundColor();
            InitTextView();
            _closeIcon.SetImageResource(Resource.Drawable.ic_close_circle_grey600_24dp);
        ...
        {
            Close?.Invoke(sender, System.EventArgs.Empty);
        }

        protected virtual void OnSelectClick(object sender, bool selected)
        {
            Select?.Invoke(sender, System.EventArgs.Empty);
        }

        protected virtual void OnIconClick(object sender, System.EventArgs args)
        {
